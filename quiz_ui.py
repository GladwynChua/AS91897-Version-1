...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.canvas = Canvas(width=800, height=200)
    ...
    def display_title(self):
        ...
        title = Label(self.window, text="General Knowledge Quiz",
                      width=82, bg="maroon", fg="white", font=("ariel", 20, "bold"))
    ...
    def next_btn(self):
        ...
        if self.quiz.check_answer(self.user_answer.get()):
            ...
            self.feedback.place(x=60, y=500)
